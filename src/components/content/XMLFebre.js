...
<Unscramble>
	...
	<fase2>
		...
		<Conteudo2>
			<Dica>A FAU, Febre amarela ________, é transmitida pelo 𝘈𝘦𝘥𝘦𝘴 𝘢𝘦𝘨𝘺𝘱𝘵𝘪, pode contaminar o homem caso o inseto esteja infectado com o vírus causador da doença.</Dica>
	...
	<fase4>
		...
		<Conteudo4>
			<Dica>Assim como as demais doenças transmitidas pelo mosquito 𝘈𝘦𝘥𝘦𝘴 𝘢𝘦𝘨𝘺𝘱𝘵𝘪, foi durante as grandes __________ que a febre amarela foi introduzida nas Américas.</Dica>
		...
		<Conteudo4>
			<Dica>Assim como a dengue a febre amarela também se comporta como uma doença sem _____________ pois nem todos que são infectados desenvolvem os sintomas.</Dica>
	...
	<fase5>
		...
		<Conteudo5>
			<Dica>Primeira doença causada pelo mosquito 𝘈𝘦𝘥𝘦𝘴 𝘢𝘦𝘨𝘺𝘱𝘵𝘪.</Dica>
			<PalavraAssoc>FEBRE AMARELA</PalavraAssoc>
		</Conteudo5>
		<Conteudo5>
			<Dica>O médico Dr. Drauzio _______________ quase perdeu a vida no ano de 2004, porque esqueceu de se prevenir contra a febre amarela ao viajar para o norte do Brasil.</Dica>
			<PalavraAssoc>VARELLA</PalavraAssoc>
		</Conteudo5>
		<Conteudo5>
		...
		<Conteudo5>
			<Dica>A existência do ciclo silvestre da febre amarela foi descoberta em 1932, derrubando o mito de ser uma “doença da _______”.</Dica>
			<PalavraAssoc>CIDADE</PalavraAssoc>
		</Conteudo5>
		<Conteudo5>
		...
		<Conteudo5>
			<Dica>Órgão do governo responsável pelo combate do vetor da Febre Amarela é o ministério da __________ .</Dica>
			<PalavraAssoc>SAÚDE</PalavraAssoc>
		</Conteudo5>
		<Conteudo5>
			<Dica>Hábito de se alimentar de sangue praticado pelas fêmeas do vetor 𝘈𝘦𝘥𝘦𝘴 𝘢𝘦𝘨𝘺𝘱𝘵𝘪.</Dica>
		...
		<Conteudo5>
			...
			<PalavraAssoc>ALTERAÇÕES</PalavraAssoc>
		</Conteudo5>
	</fase5>
</Unscramble>`
